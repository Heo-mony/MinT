...
from components.CAA import CAA
from components.CGAFusion import CGAFusion
from mlp import INR
...
class TransformerBlock(nn.Module):
    def __init__(self, dim, num_heads, ffn_expansion_factor, bias, LayerNorm_type, BasicConv=BasicConv):
        ...
        # self.attn = CAA(channels=dim, h_kernel_size=11, v_kernel_size=11)
...
class MultiscaleNet(nn.Module):
    def __init__(self,
        ...
        # self.BF1 = CGAFusion(dim * 4)
        self.BF2 = Fusion(dim * 4)
        # self.BF2 = CGAFusion(dim * 4)
        self.BF3 = Fusion(dim * 4)
        # self.BF3 = CGAFusion(dim * 4)
