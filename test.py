...
parser.add_argument('--input_dir', default='Datasets/DDN-Data/test/input/', type=str, help='Directory of validation images')
parser.add_argument('--output_dir', default='./results/DDN-Data', type=str, help='Directory of validation images')
parser.add_argument('--weights', default='PreTrainModel/model_large_DDN.pth', type=str, help='Path to weights') 
