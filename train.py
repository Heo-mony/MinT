...
parser.add_argument('--pretrain_weights', default='PreTrainModel/model_large_Rain200L.pth', type=str, help='Path to pretrain-weights')
...
RESUME = False
Pretrain = True
model_pre_dir = 'PreTrainModel/model_Rain200L_epoch_156.pth'
